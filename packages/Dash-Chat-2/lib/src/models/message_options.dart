...
class MessageOptions {
  const MessageOptions({
    this.onTapChatHeaderAvatar,
    this.onTapCommunityGuideline,
  ...
  final void Function(ChatUser user)? onTapChatHeaderAvatar;

  final void Function()? onTapCommunityGuideline;
}
