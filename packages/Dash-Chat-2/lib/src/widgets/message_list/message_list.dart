...
class _MessageListState extends State<MessageList> {
      ...
      child: Stack(
        children: <Widget>[
          Column(
            ...
            mainAxisAlignment: widget.messages.isNotEmpty ? MainAxisAlignment.start : MainAxisAlignment.end,
            children: <Widget>[
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int i) {
                      ...
                      final bool isAfterDateSeparator =
                          _shouldShowDateSeparator(previousMessage, message, widget.messageListOptions);
                      bool isBeforeDateSeparator = false;
                      if (nextMessage != null) {
                        isBeforeDateSeparator =
                            _shouldShowDateSeparator(message, nextMessage, widget.messageListOptions);
                      }
                      return Column(
                        children: <Widget>[
                          ...
                          if (widget.messageOptions.messageRowBuilder != null) ...<Widget>[
                            widget.messageOptions.messageRowBuilder!(
                                ...
                                MessageRow(
                                  key: ValueKey<String>(widget.messages[i].id),
  ...
  bool _shouldShowDateSeparator(
      ChatMessage? previousMessage, ChatMessage message, MessageListOptions messageListOptions) {
  ...
  Future<void> _onScroll() async {
    bool topReached = scrollController.offset >= scrollController.position.maxScrollExtent &&
